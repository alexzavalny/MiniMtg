...
def build_deck_pdf(deck_id, deck, cards):
    filename = {'red': 'plamya.pdf', 'green': 'les.pdf', 'white': 'svet.pdf', 'blue': 'voda.pdf', 'black': 'mogila.pdf', 'tide': 'priliv.pdf', 'sonic': 'sonic.pdf'}[deck_id]
...
def build_rules():
    ...
    y = section(c, 'Победа', [
        ...
        'В игре против компьютера вы выбираете одну из семи готовых колод. У каждой колоды 40 карт.',
    ], y)
    ...
    y = section(c, 'Семь колод', [
        ...
        'Соник (U/R) - быстрые герои, полезные гаджеты и персонажи со всего мира Соника. Разгоняйте темп и поддерживайте команду артефактами.',
    ], y)
