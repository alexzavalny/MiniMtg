...
def build_deck_pdf(deck_id, deck, cards):
    filename = {'red': 'plamya.pdf', 'green': 'les.pdf', 'white': 'svet.pdf', 'blue': 'voda.pdf', 'black': 'mogila.pdf'}[deck_id]
...
def build_rules():
    ...
    y = section(c, 'Победа', [
        ...
        'В игре против компьютера вы выбираете одну из четырёх готовых колод. У каждой колоды 40 карт.',
    ], y)
